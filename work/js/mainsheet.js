        ...
        this.draw = function(percent) {
            ...
            var l = function(s, u) {
                ...
                if (settings.showText === true) {
                    ...
                    ctx.font =  settings.fontWeight + " " + settings.fontSize + " " + settings.fontFamily;
...
(function ($) {			 
	...
	if (isTouch) { $('#block-websitewebshopblock').addClass('animated'); }
	...
	// Showed...
	$("#block-websitewebshopblock:not(.animated)").each(function () {
	  var $this     = $(this),
	...
	// Hidden...
	$("#block-websitewebshopblock.animated").each(function (index) {
	  var $this     = $(this),
		  offsetTop = $this.offset().top;
	  if (scrolled + win_height_padded < offsetTop) {
	...
	/*Slick*/
	$( document ).ready(function() {
	  /* Give slider arrows a text to increase lighthouse score */
	  $('a.carousel-control').each(function() {
	    $(this).append('<p>anchor</p>');
    });
    /*Slider*/
		...
		$(".quicktabs-tabs li a").each(function(i, element)
        {
            if((window.location.hash=="#magento" && i==0) || (window.location.hash=="#typo3" && i==1) || (window.location.hash=="#drupal" && i==2) || (window.location.hash=="#other" && i==3))
            {       
                ...
                if (!tab.tabpage.hasClass("quicktabs-tabpage")) {console.log(tab);
		...
		$(document).on('scroll', function() {
			if($('#block-sdm-magentocontent').length > 0)
			{				
				if($(this).scrollTop()>=$('#block-sdm-magentocontent').position().top){	
					$('#block-sdm-magentoblock2-2').addClass('animated fadeInDown');
				   if(checkonce == false) {
						...
						/*var speed = 50;
						var diameter = 50;
						var lineColor = 'rgba(237,71,28,1)';
						var remainingLineColor = 'rgba(255,255,255,1)';
						var lineWidth = 15;
						var start = 'bottom';
						...
						$('#authorized-module').ClassyLoader({
							percentage: 25,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						$('#magento-stability').ClassyLoader({
							percentage: 95,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						//Enterprise
						$('#magento-support-enter').ClassyLoader({
							percentage: 100,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						$('#authorized-module-enter').ClassyLoader({
							percentage: 100,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						$('#magento-stability-enter').ClassyLoader({
							percentage: 99,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						$('#open-source-enter').ClassyLoader({
							percentage: 100,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						$('#user-friendly-enter').ClassyLoader({
							percentage: 100,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
						...
						$('#magento-speed-enter').ClassyLoader({
							percentage: 100,
							speed: speed,	
							diameter: diameter,
							lineColor: lineColor,
		...
		$(".more-case-block .views-row .views-field-field-thumbnail .field-content").each(function () {
		...
		//$("#block-pagetitle h1 span").fitText( ((($("#block-pagetitle h1 span").html().length/3) * 2)/10) );
		$("#block-pagetitle h1 span").fitText();
		/*$("#block-pagetitle h1 span").bigText({
      //limitingDimension: "width",
    });*/
		
		//$('div[id^="block-views-block-cases-menu"] div div[class^="js-view-dom-id"]').slick({
		$('div[id^="block-sdm-views-block-cases-menu"] div div[class^="js-view-dom-id"]').slick({																																												
			dots: false,
			infinite: true,
			centerMode: true,
			slidesToShow: 8,
			slidesToScroll: 1,
			initialSlide: setNavigation(),
			variableWidth: true
		});
		
		$("button.slick-arrow").click(function(e) {
		...
		/*$("#block-mobilemenuclose a.close").click(function(e) {
			$(".navbar-collapse.collapse").removeClass("in", 1000, "easeInBack");					
		});*/
		
		/*Youtube Video*/
		$(".case-slider").click(function(e) {					
			$(this).find('.fc-image-masked.fc-video.active').filter(function () {															
				...
				{					
					 $("body").append('<div class="grtyoutube-popup grtyoutube-dark-theme">'+
								'<div class="grtyoutube-popup-content">'+
									...
									'<iframe class="grtyoutube-iframe" src="https://www.youtube.com/embed/'+video_id+'?rel=0&wmode=transparent&autoplay=true&iv_load_policy=3" allowfullscreen frameborder="0"></iframe>'+
								'</div>'+
							'</div>');					
				}//video_id			
			});						
		...
		$(document).on('click','.grtyoutube-popup-close',function(){		
	...
	/*Slick*/
  	...
  	/*Profile Breadcrums*/
	$("#block-profilebreadcrumbs ul li a").click(function() {
		$('html,body').animate({
	...
	$(document).ready(function() {
		...
		var moretext = "+ More";
		var lesstext = "";
		$('#block-leftrightblock13content').each(function() {
		//$('div[id^="block-leftrightblock"] div[id$="content"]').each(function() {
			...
			if(content.length > showChar) {
				...
				var less_content = htmlSubstring(content, showChar);
				var more_content = htmlSubstring(content, content.length - showChar);								
				var html = less_content + '<div class="morecontent">' + more_content + '<a href="#'+ $(this).attr("id") +'" class="morelink">' + moretext + '</a></div>';
	...
	/*Main Menu*/
	if($(".user-menu-wrapper #block-sdm-mainnavigation ul li a.is-active").length > 0)
		$(".user-menu-wrapper #block-sdm-mainnavigation ul li a.is-active").parents('li').addClass('active');
	/*Main Menu*/
  	...
  	function setNavigation() {
		...
		var i = 0;
		$('div[id^="block-sdm-views-block-cases-menu"] .views-row').each(function () {
    ...
    $('.mailto').on('click', function(e) {
        e.preventDefault();
        const emailParts = $(this).find('.emailpart');
        let email = '';

        for (i = 0; i < emailParts.length; ++i) {
            email = reverse(emailParts[i].innerHTML) + email;
        }
    ...
    $('.new-case-team-box').on('click', function(e) {
      var employeeActive = $('.employee-active');

      if (employeeActive.length) {
        if (!$(this).hasClass('employee-active')) {
          employeeActive.toggleClass('employee-active');
          employeeActive.find('.new-case-contact-box').toggle();
          employeeActive.find('.new-case-team-arrow').toggleClass('new-case-team-downward-arrow');
          employeeActive.find('.new-case-team-arrow').toggleClass('new-case-team-forward-arrow');
        } else {
          $("#employees").toggleClass('active');
        }
      } else {
        $("#employees").toggleClass('active');
      }

      $(this).toggleClass('employee-active');
      $(this).find('.new-case-contact-box').toggle();
      $(this).find('.new-case-team-arrow').toggleClass('new-case-team-downward-arrow');
      $(this).find('.new-case-team-arrow').toggleClass('new-case-team-forward-arrow');
    });

    $(document).mouseup(function(e) {
      var employeeActive = $('.employee-active');
      var container = $(".new-case-team-box");
    ...
    var sliders = $('.new-case-slider-box');
    var currentIndex = 0;
    var slidersLength = sliders.length;

    if (isMobile) {
      /* Next */
      $('#new-case-slider-right').click(function() {
        if ((currentIndex+1) < slidersLength) {
          $('#new-case-slider').animate({
            "left":     "-=100%"
          }, "linear", function() {
          });
          ++currentIndex;
          $('#new-case-slider-left').removeClass('new-case-slider-arrow-left-disabled').addClass('new-case-slider-arrow-left');
          if ((currentIndex + 1) === slidersLength) {
            $('#new-case-slider-right').removeClass('new-case-slider-arrow-right').addClass('new-case-slider-arrow-right-disabled');
          }
        }
      });

      /* Prev */
      $('#new-case-slider-left').click(function() {
        if (currentIndex > 0) {
          $('#new-case-slider').animate({
            "left":     "+=100%"
          }, "linear", function() {
          ...
          --currentIndex;
          $('#new-case-slider-right').removeClass('new-case-slider-arrow-right-disabled').addClass('new-case-slider-arrow-right');
          if (currentIndex === 0) {
            $('#new-case-slider-left').removeClass('new-case-slider-arrow-left').addClass('new-case-slider-arrow-left-disabled');
          }
        }
      });
      ...
      /* Next */
      $('#new-case-slider-right').click(function() {
        if ((currentIndex + 3) < slidersLength) {
          $('#new-case-slider').animate({
            "left":     "-=34%"
          }, "linear", function() {
          });
    ...
    Slick.prototype.setCSS = function(position) {
        ...
        if (_.transformsEnabled === false) {
            ...
            if (_.cssTransitions === false) {
				...
				/*Oxygen*/
				if(_.slideCount==1)
					positionProps[_.animType] = 'translate3d(0px, ' + y + ', 0px)';
				else
  ...
  $.fn.fitText = function( kompressor, options ) {
    ...
    return this.each(function(){
      ...
      var resizer = function () {
		...
		$this.css('font-size', Math.max(Math.min(($this.width() / (compressor*10))-10, parseFloat(settings.maxFontSize)), parseFloat(settings.minFontSize)));
		//alert($("#block-pagetitle h1 span").height());
		//$this.css('font-size', Math.max(Math.min($this.width() / ( (($this.html().length)/10) *10), parseFloat(settings.maxFontSize)), parseFloat(settings.minFontSize)));
		
		/*if($this.html().length > 13 )
		{
			$totalwidth = $this.width() / (compressor*10);
			$this.css('font-size', Math.max(Math.min($totalwidth - $this.html().length, parseFloat(settings.maxFontSize)), parseFloat(settings.minFontSize)));
		}
		else
		{
			$totalwidth = $this.width() / ($this.html().length*10);
			$this.css('font-size', Math.max(Math.min($totalwidth + $this.html().length, parseFloat(settings.maxFontSize)), parseFloat(settings.minFontSize)));
		}*/
      };
	...
	$burger.on('click', function(e) {
		...
		if(!isChangingState) {
			...
			if(!isOpen) {
				...
				$('.user-menu-wrapper').toggleClass('menu-show');
				//User Menu
			}
			else {
				showOpenBurger();
